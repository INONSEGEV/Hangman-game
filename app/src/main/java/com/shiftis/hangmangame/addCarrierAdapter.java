...
public class addCarrierAdapter extends RecyclerView.Adapter<addCarrierAdapter.wordItem> {
    ...
    public addCarrierAdapter(Context context, List<String> dataList) {
...
//        editor.apply();
    ...
    public static class wordItem extends RecyclerView.ViewHolder {
        ...
        public wordItem(View itemView) {
            ...
            words = itemView.findViewById(R.id.innerRecyclerView);
        }
    }
